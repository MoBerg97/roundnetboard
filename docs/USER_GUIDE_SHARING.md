...
4. A notification shows the file location
5. You can find the file in your app's documents folder

## Importing a Shared Project

1. Receive or download the project `.json` file
2. Open RoundnetBoard
3. Tap the **⬆** (upload) floating button at the bottom of the projects list
4. Select the `.json` file from your device
5. The project is imported with all its data!

**Note:** If a project with the same name already exists, a number is automatically added (e.g., "My Project (1)").

## What's Included in a Shared Project?
...
- Projects are exported as plain JSON text files
- No personal data is included
- Files are stored locally on your device
- Sharing uses your device's standard share mechanisms
...
- File extension: `.json`
- Typical file size: 10-200 KB depending on project complexity
- Compatible with all platforms (Android, iOS, Windows, Mac, Linux, Web)

---

Need help? Found a bug? Contact support or check the documentation.
